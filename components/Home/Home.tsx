...
const Home = () => {
  ...
  return (
    <div className="min-h-screen overflow-hidden bg-black text-slate-900 dark:bg-black dark:text-white">
      ...
      <div className="fixed bottom-20 right-4 z-50 flex flex-col items-center gap-3 sm:bottom-6 sm:right-24 lg:right-28">
        <a
          href="https://www.instagram.com/sites_profissionai/"
          target="_blank"
          rel="noreferrer"
          aria-label="Instagram"
          className="inline-flex h-14 w-14 items-center justify-center rounded-[18px] bg-[radial-gradient(circle_at_30%_107%,#fdf497_0%,#fdf497_5%,#fd5949_45%,#d6249f_60%,#285AEB_90%)] text-white shadow-[0_12px_30px_rgba(214,36,159,0.45)] transition hover:-translate-y-0.5 hover:shadow-[0_16px_36px_rgba(214,36,159,0.6)]"
        >
        ...
        <a
          ...
          className="inline-flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_12px_30px_rgba(37,211,102,0.45)] transition hover:-translate-y-0.5 hover:shadow-[0_16px_36px_rgba(37,211,102,0.6)]"
        >
