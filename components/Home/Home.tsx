  ...
  return (
    <div className="min-h-screen overflow-hidden bg-black text-slate-900 dark:bg-black dark:text-white">
      ...
      <a
        ...
        className="fixed bottom-6 right-24 z-50 inline-flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_12px_30px_rgba(37,211,102,0.45)] transition hover:-translate-y-0.5 hover:shadow-[0_16px_36px_rgba(37,211,102,0.6)] sm:right-28"
      >
