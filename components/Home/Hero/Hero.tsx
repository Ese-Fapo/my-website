  ...
  return (
    <section className="relative isolate overflow-hidden">
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute inset-0 opacity-55 sm:opacity-30 bg-[radial-gradient(1.5px_1.5px_at_18px_26px,#38bdf8_70%,transparent_70%),radial-gradient(1.5px_1.5px_at_84px_58px,#f472b6_70%,transparent_70%),radial-gradient(1.5px_1.5px_at_44px_110px,#a78bfa_70%,transparent_70%),radial-gradient(1.5px_1.5px_at_124px_34px,#facc15_80%,transparent_70%),radial-gradient(1.5px_1.5px_at_64px_150px,#34d399_70%,transparent_70%)] dark:opacity-95 dark:bg-[radial-gradient(1.5px_1.5px_at_18px_26px,#22d3ee_90%,transparent_70%),radial-gradient(1.5px_1.5px_at_84px_58px,#f472b6_90%,transparent_70%),radial-gradient(1.5px_1.5px_at_44px_110px,#a78bfa_90%,transparent_70%),radial-gradient(1.5px_1.5px_at_124px_34px,#fde047_95%,transparent_70%),radial-gradient(1.5px_1.5px_at_64px_150px,#4ade80_90%,transparent_70%)] bg-size-[180px_180px] animate-star-drift motion-reduce:animate-none" />
        <div className="absolute inset-0 opacity-70 sm:hidden bg-[radial-gradient(2px_2px_at_30px_24px,#e2e8f0_90%,transparent_70%),radial-gradient(2px_2px_at_96px_72px,#cbd5f5_90%,transparent_70%),radial-gradient(2px_2px_at_52px_140px,#f472b6_85%,transparent_70%),radial-gradient(2px_2px_at_140px_44px,#7dd3fc_90%,transparent_70%),radial-gradient(2px_2px_at_78px_190px,#a78bfa_85%,transparent_70%)] dark:opacity-95 dark:bg-[radial-gradient(2px_2px_at_30px_24px,#ffffff_95%,transparent_70%),radial-gradient(2px_2px_at_96px_72px,#dbeafe_95%,transparent_70%),radial-gradient(2px_2px_at_52px_140px,#fbcfe8_95%,transparent_70%),radial-gradient(2px_2px_at_140px_44px,#bae6fd_95%,transparent_70%),radial-gradient(2px_2px_at_78px_190px,#ddd6fe_95%,transparent_70%)] bg-size-[140px_140px] animate-star-drift-fast-twinkle motion-reduce:animate-none" />
        <div className="absolute inset-0 opacity-50 sm:opacity-25 bg-[radial-gradient(2px_2px_at_12px_18px,#94a3b8_70%,transparent_65%),radial-gradient(2px_2px_at_72px_86px,#7dd3fc_70%,transparent_70%),radial-gradient(2px_2px_at_116px_46px,#f9a8d4_70%,transparent_70%),radial-gradient(2px_2px_at_46px_128px,#c4b5fd_70%,transparent_70%)] dark:opacity-90 dark:bg-[radial-gradient(2px_2px_at_12px_18px,#ffffff_95%,transparent_65%),radial-gradient(2px_2px_at_72px_86px,#67e8f9_95%,transparent_70%),radial-gradient(2px_2px_at_116px_46px,#f9a8d4_95%,transparent_70%),radial-gradient(2px_2px_at_46px_128px,#c4b5fd_95%,transparent_70%)] bg-size-[140px_140px] animate-star-drift-fast-twinkle motion-reduce:animate-none" />
        <div className="absolute inset-0 opacity-45 sm:opacity-20 bg-[radial-gradient(1px_1px_at_14px_22px,#94a3b8_60%,transparent_70%),radial-gradient(1px_1px_at_62px_88px,#94a3b8_55%,transparent_70%),radial-gradient(1px_1px_at_104px_40px,#94a3b8_55%,transparent_70%),radial-gradient(1px_1px_at_36px_126px,#94a3b8_55%,transparent_70%)] dark:opacity-70 dark:bg-[radial-gradient(1px_1px_at_14px_22px,#ffffff_80%,transparent_70%),radial-gradient(1px_1px_at_62px_88px,#ffffff_70%,transparent_70%),radial-gradient(1px_1px_at_104px_40px,#ffffff_70%,transparent_70%),radial-gradient(1px_1px_at_36px_126px,#ffffff_70%,transparent_70%)] bg-size-[150px_150px] animate-star-drift-alt motion-reduce:animate-none" />
        <div className="absolute inset-0 opacity-40 sm:opacity-20 bg-[radial-gradient(1px_1px_at_28px_18px,#94a3b8_55%,transparent_70%),radial-gradient(1px_1px_at_78px_98px,#94a3b8_55%,transparent_70%),radial-gradient(1px_1px_at_120px_52px,#94a3b8_55%,transparent_70%),radial-gradient(1px_1px_at_48px_140px,#94a3b8_55%,transparent_70%)] dark:opacity-65 dark:bg-[radial-gradient(1px_1px_at_28px_18px,#ffffff_70%,transparent_70%),radial-gradient(1px_1px_at_78px_98px,#ffffff_70%,transparent_70%),radial-gradient(1px_1px_at_120px_52px,#ffffff_70%,transparent_70%),radial-gradient(1px_1px_at_48px_140px,#ffffff_70%,transparent_70%)] bg-size-[170px_170px] animate-star-drift-vert motion-reduce:animate-none" />
