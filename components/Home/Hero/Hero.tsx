  ...
  return (
    <section className="relative isolate overflow-hidden">
      <div className="absolute inset-0 -z-10">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,#e0f2fe_0%,#f8fafc_55%,#e2e8f0_100%)] dark:bg-[radial-gradient(ellipse_at_top,#1e3a8a_0%,#0b1020_45%,#020617_100%)]" />
        ...
        <div className="absolute -right-24 top-8 h-72 w-72 rounded-full bg-linear-to-br from-indigo-400/30 via-fuchsia-500/20 to-transparent blur-3xl animate-nebula-shift motion-reduce:animate-none" />
        <div className="absolute left-8 bottom-10 h-56 w-56 rounded-full bg-linear-to-br from-cyan-400/30 via-blue-500/20 to-transparent blur-2xl animate-nebula-shift motion-reduce:animate-none" />
      </div>
      ...
      <div className="relative mx-auto flex min-h-[70vh] max-w-6xl flex-col items-start justify-center gap-6 px-6 py-24 sm:py-28 lg:px-8">
        ...
        <h1 className="text-4xl font-bold leading-tight text-slate-900 dark:text-white sm:text-5xl lg:text-6xl">
          We Build High-Converting Website That 
        ...
        <p className="max-w-2xl text-base text-slate-700/90 dark:text-slate-200/90 sm:text-lg">
            Our team of expert developers and designers create stunning, user-friendly websites that drive traffic and boost conversions. Let us help you take your online presence to the next level.
        </p>
        ...
        <div className="mt-6 grid w-full max-w-3xl grid-cols-1 gap-4 text-sm text-slate-700/80 dark:text-slate-200/80 sm:grid-cols-3">
          <div className="rounded-2xl border border-slate-200 bg-white/80 p-4 shadow-sm dark:border-white/10 dark:bg-white/5">
            <p className="text-xs uppercase tracking-[0.2em] text-slate-500 dark:text-slate-300">designed to convert</p>
            <p className="mt-2 text-lg font-semibold text-slate-900 dark:text-white">Website sells while you sleep</p>
          </div>
          <div className="rounded-2xl border border-slate-200 bg-white/80 p-4 shadow-sm dark:border-white/10 dark:bg-white/5">
            <p className="text-xs uppercase tracking-[0.2em] text-slate-500 dark:text-slate-300">mobile first</p>
            <p className="mt-2 text-lg font-semibold text-slate-900 dark:text-white">Optimized for all devices</p>
          </div>
          <div className="rounded-2xl border border-slate-200 bg-white/80 p-4 shadow-sm dark:border-white/10 dark:bg-white/5">
            <p className="text-xs uppercase tracking-[0.2em] text-slate-500 dark:text-slate-300">engaging design</p>
            <p className="mt-2 text-lg font-semibold text-slate-900 dark:text-white">Captivating visuals that keep users hooked</p>
          </div>
        </div>
      </div>
    </section>
