...
const ResponsiveNav = () => {
  ...
  return (
    <header className="sticky top-0 z-50">
      <div className="border-b border-[#1c2541] bg-[#11172a]/85 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
          ...
          <div className="lg:hidden">
            <button
              ...
              className="inline-flex h-11 w-11 items-center justify-center rounded-full border border-[#2a344f] bg-[#131b31] text-slate-200 shadow-sm transition hover:border-[#364469] hover:text-white"
