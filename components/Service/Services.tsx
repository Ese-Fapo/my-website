...
const services = [
  ...
  },
  {
    title: "UI/UX Design",
    description:
      "Interfaces modernas com foco em usabilidade e resultados reais.",
    icon: PencilSquareIcon,
  },
  {
    title: "SEO & Performance",
    description:
      "Sites prontos para rankear no Google com carregamento ultra-rápido.",
  ...
  },
  {
    ...
    description:
      "Monitoramento e insights para otimizar conversão e campanhas.",
    icon: ChartBarIcon,
  },
]
