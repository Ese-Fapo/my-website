...
const translations: Record<Locale, TranslationSchema> = {
  pt: {
    ...
    localSeo: {
      ...
      description: "Desenvolvemos sites profissionais com SEO local, Google Business Profile e Google Maps para empresas que querem atrair mais clientes em Santa Catarina.",
      ...
      highlights: [
        ...
        { title: "SEO Local em Santa Catarina", description: "Otimização completa para seu site aparecer nas buscas por “criação de sites” em Florianópolis, São José e toda a região." },
      ],
  ...
  en: {
    ...
    localSeo: {
      ...
      description: "We create SEO-focused websites with Google Business Profile and Google Maps integration to help businesses attract more local customers across Santa Catarina.",
      ...
      highlights: [
        ...
        { title: "Local SEO in Santa Catarina", description: "Complete optimization to help your website appear in searches for “website design” and “site creation” in Florianópolis, São José, and across the region." },
      ],
  ...
  es: {
    ...
    localSeo: {
      ...
      description: "Creamos sitios web optimizados para SEO local, con integración con Google Business Profile y Google Maps, para ayudar a las empresas a atraer más clientes en Santa Catarina.",
      ...
      highlights: [
        ...
        { title: "SEO Local en Santa Catarina", description: "Optimización completa para que tu sitio aparezca en búsquedas de “creación de sitios web” en Florianópolis, São José y toda la región." },
      ],
